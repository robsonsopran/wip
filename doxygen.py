...
def arquivos_modificados_com_palavras_chave(diff, palavras_chave):
    ...
    """
    # Compila o regex para buscar as palavras-chave
    ...
    for bloco in blocos[1:]:  # Ignora o primeiro elemento vazio
...
"""
    ...
    # Exibe os arquivos
    print("Arquivos que sofreram modificações nas linhas contendo as palavras-chave:")
